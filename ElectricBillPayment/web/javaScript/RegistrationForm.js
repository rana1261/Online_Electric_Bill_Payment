var countryInfo = {
       ...
       "Rangpur":{
		"Dinajpur":["Birampur","Birganj","Biral","Bochaganj","Chirirbandar","Phulbari","Ghoraghat","Hakimpur","Kaharole","Dinajpur Sadar","Nawabganj","Parbatipur"],
		"Gaibandha":["Phulchhari","Gaibandha Sadar","Gobindaganj","Sadullapur", "Sughatta","Sundarganj","Palashbari"],
	  ...
	  "Barisal":{
	   ...
	   "Pirojpur":["Bhandaria","Kawkhali","Mathbaria","azirpur", "Pirojpur Sadar","Nesarabad","Zianagar"]
	  	  },
	   ...
	   "Chittagong":["Anwara","Banshkhali","Boalkhali","Chandanaish","Fatikchhari","Hathazari","Karnaphuli","Lohagara","Mirsharai","Patiya","Rangunia","Raozan","Sandwip","Satkania","Sitakunda","Bandar","Chandgaon","Double Mooring","Kotwali","Pahartali","Panchlaish","Bhujpur"],
	   "Comilla":["Barura","Brahmanpara","Burichang","Chandina","Chauddagram","Daudkandi","Debidwar","Homna","Laksam","Muradnagar","Nangalkot","Comilla Adarsha Sadar","Meghna","Titas","Monohargonj","Comilla Sadar Dakshin"],
	   ...
	   "Jhenaida":["Harinakunda","Jhenaidah Sadar","Kaliganj","Kotchandpur","Maheshpur","Shailkupa"],
	   "Khulna":["Batiaghata","Dacope","Dumuria","Dighalia","Koyra","Paikgachha","Phultala","Terokhada","Daulatpur","Khan Jahan Ali","Kotwali","Sonadanga","Harintana"],
	  ...
	  "Sylhet":{
	  "Habiganj":["Ajmiriganj","Bahubal","Baniyachong","Habiganj Sadar","Madhabpur","Nabiganj","Sayestaganj","Lakhai","Chunarughat"],
	  "Moulvibazar":["Barlekha","Juri","Kamalganj","Kulaura","Moulvibazar Sadar","Rajnagar","Sreemangal"],
	  "Sunamganj":["Bishwamvarpur","Chhatak","Dakshin Sunamganj","Derai","Dharamapasha","Dowarabazar","Jamalganj","Sullah","Sunamganj Sadar","Tahirpur","Jagannathpur"],
...
window.onload = function () {
	...
	//Get html elements
	var divisionSel = document.getElementById("divisionSel");
	var districtSel = document.getElementById("districtSel");	
	var upazilaSel = document.getElementById("upazilaSel");
	
	
	//Load division
	for (var division in countryInfo) {
	...
	divisionSel.onchange = function () {
		 ...
		 upazilaSel.length = 1; // remove all options bar first
		 
		 
		 if (this.selectedIndex < 1)
			 return; // done
		 
		 for (var district in countryInfo[this.value]) {
	...
	districtSel.onchange = function () {
		...
		var upazilas = countryInfo[divisionSel.value][this.value];
		for (var i = 0; i < upazilas.length; i++) {
			upazilaSel.options[upazilaSel.options.length] = new Option(upazilas[i], upazilas[i]);
		}
	}	
}